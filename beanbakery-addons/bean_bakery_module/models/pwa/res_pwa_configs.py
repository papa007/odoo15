...
class ResConfigSettings(models.TransientModel):
    ...
    _pwa_icon_url_base = "/bean_bakery_module/icon"
    ...
    def get_values(self):
        ...
        res["pwa_name"] = config_parameter_obj_sudo.get_param(
            "pwa.manifest.name", default="Bean Bakery PWA"
        )
        res["pwa_short_name"] = config_parameter_obj_sudo.get_param(
            "pwa.manifest.short_name", default="Bean Bakery"
        )
        ...
        res["pwa_background_color"] = config_parameter_obj_sudo.get_param(
            "pwa.manifest.background_color", default="#ADDBC5"
        )
        res["pwa_theme_color"] = config_parameter_obj_sudo.get_param(
            "pwa.manifest.theme_color", default="#ADDBC5"
        )
        return res
